...
Census_Data = pd.read_excel(r'D:\Templates\UW Stuff\Classes\MSBA\Classes\PM Stuff for me\Environments\BG_Data.xlsx', sheet_name = 'BG_Data')
Census_Data

#assigning variable_id and values to a dataframe
SCensus_Data1 = pd.DataFrame(Census_Data['bg_geo_id'])
SCensus_Data1['variable_id'] = (Census_Data['variable_id'])
SCensus_Data1['value'] = (Census_Data['value'])
SCensus_Data1

#reverse melt (pivot) so that variable_id are columns and values are observations
SCensus_Data1 = SCensus_Data1.pivot(index = 'bg_geo_id', columns = 'variable_id')
SCensus_Data1 = SCensus_Data1['value'].reset_index()
SCensus_Data1.columns.name = None
SCensus_Data1

#this will also rename the variable_id's into their full variable names
SCensus_Data1.rename(columns = {'B01001_001E':'Sex by Age Total', 'B01001_002E':'Sex by Age Males Total',
...
SCensus_Data1.to_excel(SCensus_Datatoexcel)
...
SCensus_Data1['SexbyAge_Total'] = SCensus_Data1['Sex by Age Total'].apply(checkSexAgeTotal)
SCensus_Data1['SexbyAgeMale_Total'] = SCensus_Data1['Sex by Age Males Total'].apply(checkSexAgeTotalMale)
SCensus_Data1['SexbyAgeMale_5orUnder'] = SCensus_Data1['Sex by Age Males Under 5 Years Old'].apply(checkSexAgeMUnder5)
SCensus_Data1['SexbyAgeMale_5to9'] = SCensus_Data1['Sex by Age Males 5 to 9 Years Old'].apply(checkSexAgeM5to9)
SCensus_Data1['SexbyAgeFemale_Total'] = SCensus_Data1['Sex by Age Female Total'].apply(checkSexAgeFemaleTotal)
SCensus_Data1['SexbyAgeFemale_5Under'] = SCensus_Data1['Sex by Age Females Under 5 Years Old'].apply(checkSexAgeFUnder5)
SCensus_Data1['SexbyAgeFemale_5to9'] = SCensus_Data1['Sex by Age Females 5 to 9 Years Old'].apply(checkSexAgeF5to9)
SCensus_Data1['SexbyAgeMedian_Total'] = SCensus_Data1['Median Age by Sex'].apply(checkMedianSexAge)
SCensus_Data1['IncomeL12_Total'] = SCensus_Data1['Income in Last 12 Total'].apply(checkIncomeL12Total)
SCensus_Data1['IncomeL12_40to44'] = SCensus_Data1['Income in last 12 $40,000 to $44,999'].apply(checkIncomeL12_40to44)
SCensus_Data1['IncomeL12_45to49'] = SCensus_Data1['Income in last 12 $45,000 to $49,999'].apply(checkIncomeL12_45to49)
SCensus_Data1['IncomeL12_50to59'] = SCensus_Data1['Income in last 12 $50,000 to $59,999'].apply(checkIncomeL12_50to59)
SCensus_Data1['IncomeL12_60to74'] = SCensus_Data1['Income in last 12 $60,000 to $74,999'].apply(checkIncomeL12_60to74)
SCensus_Data1['IncomeL12_74to99'] = SCensus_Data1['Income in last 12 $75,000 to $99,999'].apply(checkIncomeL12_75to99)
SCensus_Data1['IncomeL12_100to124'] = SCensus_Data1['Income in last 12 $100,000 to $124,999'].apply(checkIncomeL12_125to149)
SCensus_Data1['IncomeL12_125to149'] = SCensus_Data1['Income in last 12 $125,000 to $149,999'].apply(checkIncomeL12_125to149)
SCensus_Data1['IncomeL12_150to199'] = SCensus_Data1['Income in last 12 $150,000 to $199,999'].apply(checkIncomeL12_150to199)
SCensus_Data1['IncomeL12_200orMore'] = SCensus_Data1['Income in last 12 $200,000 or more'].apply(checkIncomeL12_200orMore)


#to see if new datafram SCensus_Data worked, export to xlsx
SCensus_Datatoexcel = pd.ExcelWriter('SCensus_Data_Score1.xlsx')
SCensus_Data1.to_excel(SCensus_Datatoexcel)
SCensus_Datatoexcel.save()

#add total scores to dataset (function method)
SCensus_Data1['Total_Score'] = SCensus_Data1['SexbyAge_Total'] + SCensus_Data1['SexbyAgeMale_Total'] \
                               + SCensus_Data1['SexbyAgeMale_5orUnder'] + SCensus_Data1['SexbyAgeMale_5to9'] \
                               + SCensus_Data1['SexbyAgeFemale_Total'] + SCensus_Data1['SexbyAgeFemale_5Under'] \
                              + SCensus_Data1['SexbyAgeFemale_5to9'] + SCensus_Data1['SexbyAgeMedian_Total'] \
                              + SCensus_Data1['IncomeL12_Total'] + SCensus_Data1['IncomeL12_40to44'] \
                              + SCensus_Data1['IncomeL12_45to49'] + SCensus_Data1['IncomeL12_50to59'] \
                              + SCensus_Data1['IncomeL12_60to74'] + SCensus_Data1['IncomeL12_74to99'] \
                              + SCensus_Data1['IncomeL12_100to124'] + SCensus_Data1['IncomeL12_125to149'] \
                              + SCensus_Data1['IncomeL12_150to199'] + SCensus_Data1['IncomeL12_200orMore']

SCensus_Data1

#normalize total scores (function method)
xxx = SCensus_Data1[['Total_Score']].values.astype(float)
...
SCensus_Data1['Total_Score_Norm'] = Total_Score_Norm
