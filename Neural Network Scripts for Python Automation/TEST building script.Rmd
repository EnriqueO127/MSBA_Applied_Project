...
test.scores <- get_data('scores', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'eotanez', 'V4bcA82flXljIbTiEXk4', 'TEST', 5432)
test.new <- get_data('new', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'eotanez', 'V4bcA82flXljIbTiEXk4', 'TEST', 5432)
test.all <- get_data('all', 'greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'eotanez', 'V4bcA82flXljIbTiEXk4', 'TEST', 5432)
test.scores
test.new
test.all
```
...
test.model.new <- nn.model.new('greentrike.cfvgdrxonjze.us-west-2.rds.amazonaws.com', 'eotanez', 's4I8$cPPRX5x', 'TEST', 5432)
```
